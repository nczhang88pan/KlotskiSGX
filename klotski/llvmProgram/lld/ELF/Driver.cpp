...
#include "../../llvm/lib/Transforms/Instrumentation/Klotski/DeIRInstructionInsert.h"
#include <cstdlib>
#include <utility>
...
void LinkerDriver::readConfigs(opt::InputArgList &Args) {
  Config->SupportBigObject = Args.hasArg(OPT_supportBigObject);
  supportBigObject = Config->SupportBigObject;
