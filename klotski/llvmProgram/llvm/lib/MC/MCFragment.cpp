...
MCFragment::MCFragment(FragmentType Kind, bool HasInstructions,
    ...
    : Kind(Kind), HasInstructions(HasInstructions), AlignToBundleEnd(false),
      ...
      Offset(~UINT64_C(0)),OffsetInPage(~UINT64_C(0)) {
  if (Parent && !isDummy())
...
void MCFragment::destroy() {
  ...
  switch (Kind) {
    case FT_MBBegin:
          delete cast<MCBBStartFragment>(this);
          return;
      case FT_MBEnd:
          delete cast<MCReplaceableFragment>(this);
          return;
      case FT_Constant:
          delete cast<MCMBBConstantFragment>(this);
          return;
    case FT_Align:
...
LLVM_DUMP_METHOD void MCFragment::dump() {
  ...
  OS << "<";
  switch (getKind()) {
  case MCFragment::FT_Constant:OS<< "FT_Constant";break;
  case MCFragment::FT_MBEnd:OS<< "FT_MBEnd";break;
  case MCFragment::FT_MBBegin:OS<< "FT_MBBegin";break;
