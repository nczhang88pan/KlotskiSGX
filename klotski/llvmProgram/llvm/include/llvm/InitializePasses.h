...
void initializeDeIRInstructionInsertPass(llvm::PassRegistry&);
void initializeEliminateRedundantDeIRPass(llvm::PassRegistry&);
void initializeEliminateConstantInAFunctionBodyPass(llvm::PassRegistry&);
