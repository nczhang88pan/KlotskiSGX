...
class Instruction : public User,
  ...
  bool isShadowInstr;             //different from the normal instruction
  bool isDereferencedInstr;             //instructions is Dereferenced
...
public:
  ...
  bool isShadow(){ return isShadowInstr;}
  bool isDereferenced(){ return isDereferencedInstr;}
  void setIsShadow(bool val){ isShadowInstr = val;}
  void setDerefenced(bool val){ isDereferencedInstr = val;}
