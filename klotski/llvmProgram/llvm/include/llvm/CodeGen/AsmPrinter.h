...
public:
  ...
  std::map<MCSymbol*,int> MBBConstantMap;
  std::map<MCSymbol*,unsigned > MBBConstantAlignMap;
  int constantIndex=0;
  MCSymbol *currentConstantNewSymbol= nullptr;
...
public:
  ...
  void EmitFunctionBody();
    void SplitLargeBlock(MachineBasicBlock &MBB);
  void EmitMBBend(const MachineBasicBlock &MBB);
  ...
  virtual void EmitMIConstantRecordFragment(const MachineInstr &){};
  ...
  virtual void EmitInPageJmp(const MachineFunction *MF){};

  /// Targets can override this to emit stuff at the end of a basic block.
  virtual void EmitBasicBlockEnd(const MachineBasicBlock &MBB) {}

    ///Targets can override this to emit the last MI of the MBB to a new MCBBEndFragment
  virtual void EmitMBBEndMIToMCBBEndFragment(const MachineBasicBlock &MBB, MachineBasicBlock::iterator &,MachineBasicBlock::iterator){}

  /// Targets should implement this to emit instructions.
  virtual void EmitInstruction(const MachineInstr *) {
    llvm_unreachable("EmitInstruction not implemented");
  }
    virtual void EmitInlineAsmPan(const MachineInstr *){
        llvm_unreachable("EmitInlineAsmPan not implemented");
    }
