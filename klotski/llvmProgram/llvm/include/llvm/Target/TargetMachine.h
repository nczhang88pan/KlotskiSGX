...
//    /// Add passes to the specified pass manager to get the specified file
//    /// emitted. It would generate the code twice, for the first time, we would stastic
//    /// the size of each machine basic block, then use these information to do optimizations
//    /// on code existed in same shadow page
//
//    bool addPassesToEmitFileTwice(
//            PassManagerBase &PM, raw_pwrite_stream &Out, CodeGenFileType FileType,
//            bool DisableVerify = true, AnalysisID StartBefore = nullptr,
//            AnalysisID StartAfter = nullptr, AnalysisID StopBefore = nullptr,
//            AnalysisID StopAfter = nullptr,
