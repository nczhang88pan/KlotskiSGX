...
protected:
  ...
  mutable PointerIntPair<MCPage *,1> PageAndHasName;
...
public:
  ...
  void setPage(MCPage *P)const{
     PageAndHasName.setPointer(P);
  }
  ...
  MCPage *getPage(bool SetUsed= true)const{
      MCPage *Page = PageAndHasName.getPointer();
      if(Page || !isVariable())
           return Page;
      return NULL;
  }
