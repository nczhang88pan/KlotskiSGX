...
ModulePass *createDeIRInstructionInsertFunctionPass(bool CompileKernel = false,
                                                     bool Recover = false,
                                                     bool UseAfterScope = false);

ModulePass *createEliminateRedundantDeIRModulePass(bool CompileKernel = false,
                                                        bool Recover = false,
                                                        bool UseAfterScope = false);


FunctionPass *createEliminateConstantInAFunctionBodyFunctionPass(bool CompileKernel = false,
                                                          bool Recover = false,
                                                          bool UseAfterScope = false);
